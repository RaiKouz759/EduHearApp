...
public class Secondary_Page2 extends AppCompatActivity implements View.OnTouchListener, GestureDetector.OnGestureListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_secondary__page2);
        ...
        _TextToSpeechInitializer.init(this, utteranceProgressListener, _Constants.secondary2);
    }
    ...
    private void swipeLeft() {
        Intent page1 = new Intent(this, Secondary.class);
        startActivity(page1);
        finish();
        _Constants.stop();
    ...
    private void swipeRight() {
        Intent page3 = new Intent(this, Secondary_Page3.class);
        startActivity(page3);
        finish();
        _Constants.stop();
    ...
    private void swipeUp() {
        Intent history = new Intent(this, Secondary_History.class);
    ...
    private void swipeDown() {
        Intent science = new Intent(this, Secondary_Science.class);
